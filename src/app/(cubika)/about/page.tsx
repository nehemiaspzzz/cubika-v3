...
export default function About() {
    ...
    const isInView = useInView(logrosRef, { once: true });
        ...
        >
            ...
            >
                            ...
                            {[
                                {
                                    text: "Disciplina",
                                    icon: "🎯",
                                    description: "Mantenemos altos estándares en cada proyecto y decisión"
                                },
                                {
                                    text: "Responsabilidad y Compromiso",
                                    icon: "🤝",
                                    description: "Cumplimos nuestras promesas con clientes y comunidad"
                                },
                                {
                                    text: "Calidad",
                                    icon: "⭐",
                                    description: "Excelencia en cada detalle de nuestros desarrollos"
                                },
                                {
                                    text: "Innovación",
                                    icon: "💡",
                                    description: "Buscamos constantemente nuevas soluciones sostenibles"
                                },
                            ].map((item, index) => (
                                <motion.div
                                    key={index}
                                ...
                                >
                                    ...
                                    <h3 className="text-xl font-bold mb-3 text-gray-800">{item.text}</h3>
                ...
                <motion.section
                    ...
                    viewport={{ once: true }}
                    className="relative flex flex-col items-center justify-evenly my-20 w-[95%] h-[800px] mx-auto bg-about-us-image bg-cover bg-center rounded-[40px] py-12 overflow-hidden"
                >
                    ...
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        className="relative z-10 text-4xl font-extrabold uppercase text-center text-white mb-6 transition-all duration-300 ease-in-out hover:scale-105 transform-gpu"
                    >
                        Nuestros Logros
                    </motion.h2>
                    <div className="relative z-10 flex flex-col md:flex-row justify-center items-center w-full gap-8 md:gap-16">
                        ...
                        >
                            <h1 className="text-white text-center text-4xl font-extrabold">{isInView && <Counter end={350} />}</h1>
                        ...
                        <motion.div
                            ...
                            className="p-6 rounded-2xl transition-all duration-300 ease-in-out hover:scale-105 transform-gpu"
                        >
                            <h1 className="text-white text-center text-4xl font-extrabold">{isInView && <Counter end={400} />}</h1>
                        ...
                        <motion.div
                            ...
                            className="p-6 rounded-2xl transition-all duration-300 ease-in-out hover:scale-105 transform-gpu"
                        >
                            <h1 className="text-white text-center text-4xl font-extrabold">{isInView && <Counter end={2} />}</h1>
                ...
                >
                    ...
                    <Image
                        src={aboutImage}
                        alt="About Image"
                        className="w-[90%] md:w-2/3 h-auto rounded-3xl md:rounded-l-3xl relative z-0"
                    />
                </motion.section>
                <motion.section
                    initial={{ opacity: 0 }}
