const experiences = [
    {
      ...
      date: "Febrero 2022",
      points: [
        "Grupo Cubika nace con una visión estratégica: transformar espacios en desarrollos inmobiliarios que materialicen el sueño de un hogar. Como una corporación 100% guatemalteca, nos especializamos en la planificación y ejecución de proyectos innovadores que integran diseño, funcionalidad y calidad de vida, aportando valor y sostenibilidad a cada comunidad que impactamos.",
        "Nuestro mayor logro es generar empleo para más de 100 personas, de manera directa e indirecta, contribuyendo así al crecimiento económico y social del país."
      ],
    },
    {
